...
<main class="container">
    ...
    <div class="p-1 mb-2 bg-light rounded-3">
        <div class="container-fluid py-10">
          <h1 class="display-5 fw-bold">Crud PHP | Usuarios</h1>
          <p class="col-md-8 fs-4">Panel de Adiminstracion</p>
    ...
    <?php
        ...
        ?>
            <table class="table table-bordered">
                ...
                <a href="registrar.php" button class="btn btn-primary btn-lg" type="button">Agregar Usuario</button></a>
                <a href="modificarUsuario.php" button class="btn btn-primary btn-lg" type="button">Modificar Usuario</button></a>
                <a href="eliminarUsuario.php" button class="btn btn-primary btn-lg" type="button">Eliminar Usuario</button></a>
        <?php
    } else {
